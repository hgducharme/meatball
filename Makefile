...
##
## Compilation options:
##   CXX=<g++/clang++>       The compiler to use
##   CPP=<integer>           The C++ standard to use during compilation
##   DEBUG_LEVEL=<0-3>       Specify how much debugging information to produce
##   OPTIMIZATION_LEVEL=<>   The amount of optimization to use. See the compiler documentation for available options
...
## Docker
##
## (NOTE: requires the docker daemon to already be running)
##

.PHONY: docker-linter docker-tests docker-image-prune
